...
const styles = StyleSheet.create({
  ...
  slideImage: { width, height, position: "absolute", top: 0, left: 0 },
  controls: { position: "absolute", bottom: 0, left: 0, right: 0, paddingHorizontal: 24 },
  pagination: { flexDirection: "row-reverse", justifyContent: "center", gap: 8, marginBottom: 20 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  activeDot: { width: 24 },
  footer: { flexDirection: "row-reverse", marginBottom: 12 },
