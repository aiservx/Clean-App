...
const styles = StyleSheet.create({
  ...
  etaRow: { flexDirection: "row-reverse", paddingHorizontal: 16, gap: 12, marginBottom: 12 },
  ...
  actionsRow: { flexDirection: "row-reverse", paddingHorizontal: 16, gap: 10, marginTop: 8 },
