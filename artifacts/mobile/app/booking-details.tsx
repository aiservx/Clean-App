...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: "Tajawal_700Bold", fontSize: 13, marginBottom: 8, marginTop: 6 },
  tlRow: { flexDirection: "row", alignItems: "flex-start", paddingVertical: 6 },
  tlT: { fontSize: 12 },
  tlTime: { fontFamily: "Tajawal_500Medium", fontSize: 10, marginTop: 2 },
  tlIconCol: { alignItems: "center", marginStart: 12, position: "relative", paddingVertical: 4 },
