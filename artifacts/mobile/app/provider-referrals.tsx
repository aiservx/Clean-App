...
const styles = StyleSheet.create({
  ...
  codeRow: { flexDirection: "row-reverse", alignItems: "center", gap: 12 },
  code: { fontFamily: "Tajawal_700Bold", fontSize: 22, letterSpacing: 1 },
  copy: { flexDirection: "row-reverse", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 100 },
  ...
  btn: { height: 50, borderRadius: 16, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 8 },
