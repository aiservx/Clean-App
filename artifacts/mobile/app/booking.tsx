...
const styles = StyleSheet.create({
  ...
  stepNumber: { color: "#FFFFFF", fontFamily: "Cairo_700Bold", fontSize: 12 },
  stepTitle: { fontFamily: "Cairo_600SemiBold", fontSize: 10 },
  ...
  horizontalScroll: { paddingHorizontal: 24, gap: 12, marginBottom: 24 },
  dateCard: {
    width: 70,
    height: 90,
    borderRadius: 20,
  ...
  dateDay: { fontFamily: "Cairo_500Medium", fontSize: 12 },
  dateNum: { fontFamily: "Cairo_700Bold", fontSize: 18 },
  dateMonth: { fontFamily: "Cairo_400Regular", fontSize: 12 },
  timeCard: {
    width: 120,
    height: 60,
    borderRadius: 20,
  ...
  timeLabel: { fontFamily: "Cairo_500Medium", fontSize: 11 },
  timeRange: { fontFamily: "Cairo_700Bold", fontSize: 13 },
  cleanerCard: {
    width: 110,
    padding: 12,
    borderRadius: 20,
  ...
  cleanerName: { fontFamily: "Cairo_600SemiBold", fontSize: 12, marginBottom: 4, textAlign: "center" },
  ratingRow: { flexDirection: "row-reverse", alignItems: "center", gap: 2 },
  ratingText: { fontFamily: "Cairo_700Bold", fontSize: 11 },
  summaryCard: {
    marginHorizontal: 24,
    borderRadius: 24,
    padding: 20,
  ...
  summaryHeader: { fontFamily: "Cairo_700Bold", fontSize: 16, marginBottom: 16, textAlign: "right" },
  summaryRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 12 },
  summaryLabel: { fontFamily: "Cairo_500Medium", fontSize: 13 },
  summaryValue: { fontFamily: "Cairo_600SemiBold", fontSize: 13 },
  divider: { height: 1, marginVertical: 12 },
  priceRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 8 },
  priceLabel: { fontFamily: "Cairo_400Regular", fontSize: 12 },
  priceValue: { fontFamily: "Cairo_600SemiBold", fontSize: 12 },
  totalRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 4 },
  totalLabel: { fontFamily: "Cairo_700Bold", fontSize: 16 },
  totalValue: { fontFamily: "Cairo_700Bold", fontSize: 16 },
  paymentRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  paymentText: { fontFamily: "Cairo_600SemiBold", fontSize: 14 },
  ...
  confirmTitle: { color: "#FFFFFF", fontFamily: "Cairo_700Bold", fontSize: 16 },
  confirmSubtitle: { color: "rgba(255,255,255,0.85)", fontFamily: "Cairo_500Medium", fontSize: 12 },
});
