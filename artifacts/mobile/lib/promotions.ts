...
export const SEASONAL_PROMOS: SeasonalPromo[] = [
  ...
  {
    id: "rainy",
    image: require("@/assets/services/seasonal/rainy.png"),
    badge: "موسم الأمطار",
    title: "تنظيف بعد الأمطار",
    subtitle: "إزالة الطين والبقع وتجفيف السجاد بمعدات احترافية",
    discount: 18,
    code: "RAINY18",
    cta: "احجز فريق",
    textColor: "#0F172A",
    ...
    ctaBg: "#1E3A8A",
    ctaText: "#FFFFFF",
    validUntil: "ساري طوال الموسم",
  },
  {
    id: "sunny",
    image: require("@/assets/services/seasonal/sunny.png"),
    badge: "عرض الإجازات",
    title: "جهّز بيتك للسفر",
    subtitle: "تنظيف شامل قبل الإجازة لتعود إلى منزل لامع",
    discount: 22,
    code: "VACAY22",
    cta: "احجز قبل السفر",
    textColor: "#92400E",
    ...
    ctaBg: "#F59E0B",
    ctaText: "#0F172A",
    validUntil: "طوال موسم الإجازات",
  },
  {
    id: "eco",
    image: require("@/assets/services/seasonal/eco.png"),
    badge: "تنظيف أخضر",
    title: "باقة التنظيف الصديقة للبيئة",
    subtitle: "مواد طبيعية 100% آمنة على الأطفال والحيوانات الأليفة",
    discount: 12,
    code: "ECO12",
    cta: "اطلب الباقة",
    textColor: "#14532D",
