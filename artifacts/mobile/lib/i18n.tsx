...
const DICT: Dict = {
  ...
  tutorial_video: { ar: "كيفية الاستخدام", en: "How to use" },
  tutorial_video_sub: { ar: "شاهد دليل التطبيق المرئي", en: "Watch the visual app guide" },
  tutorial_video_title: { ar: "دليل الاستخدام", en: "How to Use" },
